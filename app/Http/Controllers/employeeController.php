...
class employeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $employee->designation_2 = $request->designation2;
        ...
        $employee->esitype = $request->esitype;
        $employee->esino=$request->esino;
        $employee->pfno=$request->pfno;
        $employee->nominee_name = $request->nomineename;
        $employee->nominee_num = $request->nomineembl;
        $employee->empprefix=$request->empprefix;
        $employee->otherdocument = $request->otherdocument;
        $employee->nomineerelation = $request->nomineerelation;
        $employee->otherdetails1 = $request->otherdetails1;
        $employee->otherdetails2 = $request->otherdetails2;
        $employee->otherdetails3 = $request->otherdetails3;
        $employee->otherdetails4 = $request->otherdetails4;
        ...
        if($request->hasfile('nomineefileupload'))
        {
            $file = $request->file('nomineefileupload');
            $extension = $file ->getClientOriginalExtension();
            $filename = "Nom".'_'.time().'.'.$extension;
            $file->move('images/',$filename);
            // $empimg = $filename;
            $employee->nominee_proof = $filename;
        }
        ...
        if($request->hasfile('image5'))
        {
            ...
            $extension = $file ->getClientOriginalExtension();
            $filename = "img5_".'_'.time().'.'.$extension;
            $file->move('images/',$filename);
            // $empimg = $filename;
            $employee->other_proof = $filename;
    ...
    public function getemp(Request $request)
    {
        ...
        return view('pages.emp_details',compact('emp','empfamily','empeducation','empexperience','company'));
    }
    ...
    public function empedit(Request $request)
    {
        ...
        return view('pages.empedit',compact('employee','empfamily','empeducation','empexperience','designation'));
    }
    ...
    public function updateemployee(Request $request)
    {
        ...
        $pfdata = $request->pfdata;
        $otdata = $request->otdata;
        $salarytype = $request->salarytype;
        $esitype = $request->esitype;

        $esitype = $request->esitype;
        $esino=$request->esino;
        $pfno=$request->pfno;
        $nominee_name = $request->nomineename;
        $nominee_num = $request->nomineembl;
        $empprefix=$request->empprefix;
        $otherdocument = $request->otherdocument;
        $nomineerelation = $request->nomineerelation;
        $otherdetails1 = $request->otherdetails1;
        $otherdetails2 = $request->otherdetails2;
        $otherdetails3 = $request->otherdetails3;
        $otherdetails4 = $request->otherdetails4;
        ...
        if($request->hasfile('image5'))
        {
            ...
            $filename1= "license_".time().'.'.$extension1;
            $file1->move('images/',$filename1);
            $oldotherimg = $filename1;
        }
        else
        {
            $oldotherimg = $request->oldotherdocument;
        }
        ...
        $employees = DB::table('employees')->where('id',$id)->update(array(
            ...
            'nominee_num'=>$nominee_num,
            'empprefix'=>$empprefix,
            'otherdocument'=>$oldotherimg,
