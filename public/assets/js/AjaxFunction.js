...
var html =
   '<tr><td><input class="form-control f_name1" placeholder="Name" type="text" name="f_name[]" id="f_name1"></td><td><select class="form-control f_relation" name="f_relation[]"> <option>-- Choose Relation --</option> <option value="Father">Father</option> <option value="Mother">Mother</option> <option value="Daughter">Daughter</option> <option value="Son">Son</option> <option value="Wife">Wife</option> <option value="Husband">Husband</option> </select></td><td><input placeholder="Mobile Number" class="form-control" type="text" name="f_mobile[]"></td><td><button class="btn btn-danger remove">X</button></td></tr>';
...
$(document).on('click', '.remove', function() {
   $(this).parents('tr').remove();
    ...
    $('#categorydesignation').on('blur', function() {
        check23();
    });
    ...
    function check23() {
        ...
        var category1_x = /^[a-zA-Z ]*$/;
        var category1 = $("#categorydesignation").val();
        if (!category1_x.test(category1) || category1 == "") {
            $('#category_err').html("Please enter correct Designation.");
            $("#categorydesignation").css("border", "1px solid red");
            // $("#name").focus();
            $("#category_err").show();
            valid = false;
        } else {
            $("#categorydesignation").css("border", "1px solid green");
            $("#category_err").hide();
            return false;
        }
    }
