                  ...
                  <div class="row">
                            ...
                            <select class="form-control" name="dealname">
                              ...
                              @if($quotedproducts)
                                @foreach ($quotedproducts as $products)
                                    <option value="{{ $products->id }}" @if($products->id == $leadedit->dealname) selected @endif>{{ $products->productname }}</option>
                                @endforeach
                              @endif
                            </select>
                      ...
                      {{-- <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            @if ($dealname = App\Models\Quotedproduct::where('id',$leadedit->dealname)->first())
                                <input type="text" class="form-control" name="dealname" value="{{$dealname->productname}}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Deal Name">
                            @endif
