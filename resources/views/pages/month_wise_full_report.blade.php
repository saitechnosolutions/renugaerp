                            ...
                            <tr>
                                ...
                                @if($workingdays)
                                    @foreach ($workingdays as $work)
                                        ...
                                        @if($work->dates)
                                                {{-- @if($work->dates == date("Y-m-d",strtotime("-1 days")))

                                                    @if($getyesterday = App\Models\attendance_detail::where("attedance_date",date("Y-m-d",strtotime("-1 days")))->where("empid", $qr->emp_id)->get())
                                                ...
                                                @endif --}}
                                            <td>
                                            @if($getdaily = App\Models\excel_import_attedance::where("attedance_date",$work->dates)->where("empid", $qr->emp_id)->first())
