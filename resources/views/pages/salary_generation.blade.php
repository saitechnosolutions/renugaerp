        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    ...
                    <div class="col-lg-6 monthsalaryname mt-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                  ...
                                  <div class="row">
                                      <div class="col-lg-12">
                                        <select class="form-control basic" name="" id="generatedemployee" style="width:100%">
                    ...
                    <div class="col-lg-6 datesalaryname mt-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                  ...
                                  <div class="row">
                                      <div class="col-lg-12">
                                        <select class="form-control basic" name="" id="generatedemployeecustom" style="width:100%">
                                            <option>-- Choose Employee --</option>
                                        </select>
                                      </div>
                                ...
                                <table class="table table-bordered mt-3" >
                                    <thead class="bg-danger">
                                        <tr>
                                            ...
                                            <th class="text-white">Absent Days</th>
                                            {{-- <th class="text-white">Weekoff</th> --}}
                                            <th class="text-white">Salary Days</th>
                                            <th class="text-white">Gross Salary</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control presentday" name="presentday" id="Present_days" value="0" readonly></td>
                                            <td><input type="text" class="form-control holiday" name="holiday" id="holidays" value="0" readonly></td>
                                            {{-- <td><input type="text" class="form-control weekoff" name="weekoff" id="weekoff" value="0"></td> --}}
                                            <td><input type="text" class="form-control salaryday" name="salaryday" id="salarydays" value="0" readonly></td>
                                            <td><input type="text" class="form-control actualbasic1" name="actualbasic1" id="actualbasic" value="0.00" readonly></td>
                                            ...
                                            <td><input type="text" class="form-control netsalary" name="netsalary" id="netpay" value="0.00" readonly></td>
                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <table class="table table-bordered mt-4">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th >Basic Salary</th>
                                                    <td><input type="text" class="form-control basicsalary" name="basicsalary" id="basic" value="0.00" readonly></td>
                                                </tr>
                                                <tr>
                                                    <th >House Rent Allowances</th>
                                                    <td><input type="text" class="form-control hra" id="hra" name="hra" value="0" readonly></td>
                                                </tr>
                                                <tr>
                                                    <th >Conveyance Allowances</th>
                                                    {{-- <td><input type="text" class="form-control wa" id="wa" name="wa" value="0"></td> --}}
                                                    <td><input type="text" class="form-control conveyanceallowance" id="conveyanceallowance" name="conveyanceallowance" value="0" readonly></td>
                                                </tr>
                                                <tr>
                                                    <th >Medical Allowances</th>
                                                    <td><input type="text" class="form-control medicalallowance" id="medicalallowance" name="medicalallowance" value="0" readonly></td>
                                                </tr>
                                                <tr>
                                                    <th >Special Allowances</th>
                                                    {{-- <td><input type="text" class="form-control misc" id="othmisc" name="misc" value="0"></td> --}}
                                                    <td><input type="text" class="form-control specialallowance" id="specialallowance" name="specialallowance" value="0" readonly></td>
                                                </tr>
                                                <tr>
                                                    <th >OT/Amt</th>
                                                    <td><input type="text" class="form-control amt" id="otamt" name="amt" value="0" readonly></td>
                                                </tr>
                                                <tr>
                                                    <th >OT Hrs</th>
                                                    <td><input type="text" class="form-control hrs" id="othrs" name="hrs" value="0" readonly></td>
                                                </tr>
                                                <tr>
                                                    <th >Gross Cr</th>
                                                    <td><input type="text" class="form-control grosscr" id="grosscr" name="grosscr" value="0.00" readonly></td>
                                                </tr>
                                    ...
                                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        <table class="table table-bordered mt-4">
                                            <tbody >
                                                <tr>
                                                    <th >EPF</th>
                                                    <td><input type="text" class="form-control epf1" id="epf" name="epf1" value="0.00" readonly></td>
                                                </tr>
                                                <tr>
                                                    <th >Health Insurance/ESI</th>
                                                    <td><input type="text" class="form-control esi" id="esi" name="esi" value="0.00" readonly></td>
                                                </tr>
                                                <tr>
                                                    <th >Professional Deduction</th>
                                                    <td><input type="text" class="form-control " id="professionaldeduction" name="professionaldeduction" value="0.00" readonly></td>
                                                </tr>
                                                <tr>
                                                    <th >Advance Deduction</th>
                                                    <td><input type="text" class="form-control advancededn" id="advancededn" name="advance" value="0"></td>
                                                </tr>
                                                <tr>
                                                    <th >Canteen Deduction</th>
                                                    <td><input type="text" class="form-control canteendeduc" id="canteendeduc" name="canteendeduc" value="0"></td>
                                                </tr>
                                                <tr>
                                                    <th >Loan Deduction</th>
                                                    <td><input type="text" class="form-control loandedu" id="loandedu" name="loandedu" value="0"></td>
                                                </tr>
                                                <tr>
                                                    <th >Other Deduction</th>
                                                    <td><input type="text" class="form-control othdeduc" id="othdeduc" name="othdeduc" value="0" ></td>
                                                </tr>

                                                    {{-- <th class="text-white">Canteen</th> --}}
                                                    {{-- <th class="text-white">Late dedn</th> --}}
                                                    <th>Gross Dr</th>
                                                    <td><input type="text" class="form-control grossdr" id="grosscrdedn" name="grossdr" value="0.00" readonly></td>
                                                </tr>
                                            </tbody>
                                            {{-- <tbody>
                                                <tr>
            ...
            <div class="widget-content widget-content-area" id="customsalaryperson">
                <div class="table-responsive">
                    <form method="POST" action="updatecustomdetails">
                        @csrf
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th>Deduction</th>
                            <td><input type="text" class="form-control decuction" name="customdeduc" id="customdeduc"></td>
                        </tr>
                        <tr>
                            <th>Time Deduction</th>
                            <td><input type="text" class="form-control decuction" readonly></td>
                            <th>OT</th>
                            <td><input type="text" class="form-control dailyot" name="ot" value="0" readonly></td>
                        </tr>
                        <tr>
                            <th>PF</th>
                            <td><input type="text" class="form-control" value="0" readonly></td>
                            <th>OT HRS</th>
                            <td><input type="text" class="form-control othrs" value="0" readonly></td>
                        </tr>
                        <tr>
                            <th>Salary Days</th>
                            <td><input type="text" class="form-control salary_days" readonly></td>
                            <th>Net pay</th>
                            <input type="hidden" class="form-control netpay2" readonly>
                            <td><input type="text" class="form-control netpay" name="netpay" readonly></td>
                        </tr>
                    </table>
                    <input type="hidden" name="employeeid" class="employeeid" id="employeeid">
                    <input type="hidden" name="fdate" class="fdate" id="fdate">
                    <input type="hidden" name="tdate" class="tdate" id="tdate">
                    <button type="submit" class="btn btn-success m-auto d-block">Update Details</button>
                </form>
                </div>
            </div>
        </div>
