                ...
                <section>
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-2">
                                ...
                                <select class="form-control" name="empprefix" required>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                @endif
                                <input type="text" name="empid" class="form-control" id="inputEmail4" placeholder="ID" value="" required autocomplete="off">
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control " name="empname" id="name" placeholder="Name" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="form-row mb-4">
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" onblur="fnCalculateAge();" class="form-control" name="empdob" id="dob" placeholder="" required>
                            </div>
                            <div class="form-group col-md-4 mb-4">
                                ...
                                <input type="text" class="form-control" name="empeducation" id="Qualification" placeholder="Education" autocomplete="off" required>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control f_mobile" name="empmbl" id="mobile_no" placeholder="Mobile Number" autocomplete="off" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="inputState" class="form-control" name="empgen" required>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" name="empdoj" id="inputZip" required>
                            </div>
                        </div>
                        <div class="form-row mb-4">
                            <div class="form-group col-md-6">
                                <label for="inputCity">Category <span style="color:red">*</span></label>
                                <select id="designationtype" class="form-control" name="empdesign" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="inputState" class="form-control" name="empblood" required>
                                    <option selected>Choose...</option>
                            ...
                            {{-- <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea class="form-control" name="emptempaddr" placeholder="Temporary Address" required></textarea>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="designation2" id="designation2" placeholder="Designation" autocomplete="off" required>
                                </div>
