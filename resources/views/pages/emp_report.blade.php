    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                ...
                <a onclick="window.history.back()" class="btn btn-info btn-outline fancy-button btn-0" style="font-size:16px;">Back</a>
                    </div>
                </div>
                ...
                <table id="zero-config" class="table dt-table-hover" style="width:100%">
                    ...
                    <tbody>
                        @if($employees)
                            ...
                            <tr>
                                <td>{{$emp->empprefix}}{{$emp->emp_id}}</td>
                                <td>{{$emp->name}}</td>
                                ...
                                <td>
                                    ...
                                    {{-- <a href="deleteemp/{{$emp->id}}" onclick="return confirm('Do You want Delete this Data?')" data-id="{{$emp->id}}" class="btn btn-danger deleempreport"><i class="bi bi-trash-fill"></i></a> --}}
                                    <a data-id="{{$emp->id}}" class="btn btn-danger deleempreport"><i class="bi bi-trash-fill"></i></a>
                                    <a target="_blank" href="getidcard/{{$emp->emp_id}}" class="btn btn-warning "><i class="bi bi-card-heading"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        @endif
