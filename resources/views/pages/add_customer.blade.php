            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <select id="leadid" name="leadid" class="form-control select2">
                        ...
                        @if($convertedleads)
                            @foreach ($convertedleads as $leads)
                                <option value="{{$leads->leadid}}">{{$leads->leadid}} | {{$leads->customername}}</option>
                            @endforeach
                        @endif
                                ...
                                <option value="">Select Country</option>
                                    @if($country)
                                        @foreach ($country as $c)
                                            <option value="{{$c->country_id}}" data-cname='{{$c->country_id}}'>{{$c->country_name}}</option>
                                        @endforeach
                                    @endif
