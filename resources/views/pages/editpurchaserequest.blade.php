    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                <div class="row">
                    <div class="col-lg-12">
                        <h4><b>Edit Purchase Request</b></h4>
                    </div>
                                        ...
                                        <tbody id="appendstageparent">
                                            @if($requestdetails)
                                                ...
                                                <tr class="appendstage">
                                                        ...
                                                        <select class="form-control  basic productdesc" name="productdesc[]">
                                                            ...
                                                            @if($purchaserequest = App\Models\Purchaseitem::get())
                                                                @foreach ($purchaserequest as $purchase)
                                                                    <option value="{{ $purchase->id }}" @if($request->description == $purchase->id) selected @endif>{{ $purchase->descriptions }}</option>
                                                                @endforeach
                                                            @endif
                                                    ...
                                                    <td style="width:40%">
                                                        <input type="text" class="form-control requestprice" name="price[]" value="{{ $request->price }}">
